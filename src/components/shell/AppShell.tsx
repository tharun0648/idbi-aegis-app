      ...
      <aside className="sticky top-0 flex h-screen w-64 shrink-0 flex-col bg-[#123A2E] text-[#A8C3B9]">
        ...
        <div className="mt-auto px-6 pb-5 pt-6">
          <div className="flex items-center gap-2 text-white">
            ...
            <p className="text-sm font-semibold">Explain. Recommend. Advise.</p>
          </div>
          <p className="mt-2 text-xs leading-relaxed text-[#8FB3A7]">
            Aegis evaluates MSMEs using financial and alternative data signals to assist underwriters. It does not
            auto-approve loans.
          </p>
          ...
          <div className="mt-4 flex items-center gap-3 rounded-lg border border-white/10 bg-white/5 px-3 py-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#1F5E4A] text-xs font-semibold text-white">RM</span>
